...
class build_py(Command):
    ...
    def check_package(self, package, package_dir):
        ...
        # Directories without init_db.py are namespace packages (PEP 420).
        if package:
            init_py = os.path.join(package_dir, "init_db.py")
            if os.path.isfile(init_py):
                return init_py

        # Either not in a package at all (init_db.py not expected), or
        # init_db.py doesn't exist -- so don't return the filename.
        return None
    ...
    def find_modules(self):
        ...
        #   is valid (exists, contains init_db.py, ... ?)
        packages = {}
        ...
        #   - don't check for init_db.py in directory for empty package
