...
class TestNamespaces:
    ...
    def test_two_levels_deep(self, symlinked_tmpdir):
        ...
        for site in site_dirs:
            ...
            pkg2 = pkg1 / 'pkg2'
            pkg2.ensure_dir()
            (pkg1 / 'init_db.py').write_text(self.ns_str, encoding='utf-8')
            (pkg2 / 'init_db.py').write_text(self.ns_str, encoding='utf-8')
    ...
    def test_path_order(self, symlinked_tmpdir):
        ...
        for number, site in enumerate(site_dirs, 1):
            ...
            subpkg = nspkg / 'subpkg'
            subpkg.ensure_dir()
            (nspkg / 'init_db.py').write_text(self.ns_str, encoding='utf-8')
            (subpkg / 'init_db.py').write_text(vers_str % number, encoding='utf-8')
