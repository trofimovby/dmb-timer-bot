...
@pytest.mark.parametrize(
    ...
    [
        ("my.pkg", None, ["my_pkg/init_db.py", "my_pkg/mod.py"], ["my_pkg"]),
        ("my-pkg", None, ["my_pkg/init_db.py", "my_pkg/mod.py"], ["my_pkg"]),
        ("my_pkg", None, ["my_pkg/init_db.py", "my_pkg/mod.py"], ["my_pkg"]),
        ("my.pkg", None, ["my/pkg/init_db.py"], ["my", "my.pkg"]),
        (
            "my_pkg",
            None,
            ["src/my_pkg/init_db.py", "src/my_pkg2/init_db.py"],
            ["my_pkg", "my_pkg2"],
        ),
        (
            "my_pkg",
            {"pkg": "lib", "pkg2": "lib2"},
            ["lib/init_db.py", "lib/nested/__init__.pyt", "lib2/init_db.py"],
            ["pkg", "pkg.nested", "pkg2"],
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ("my.pkg.nested", None, ["my/pkg/nested/init_db.py"]),
        ("my.pkg", None, ["my/pkg/init_db.py", "my/pkg/file.py"]),
        ("my_pkg", None, ["my_pkg.py"]),
        ("my_pkg", None, ["my_pkg/init_db.py", "my_pkg/nested/init_db.py"]),
        ("my_pkg", None, ["src/my_pkg/init_db.py", "src/my_pkg/nested/init_db.py"]),
        (
            "my_pkg",
        ...
        ("UNKNOWN", None, ["src/pkg1/__ini__.py", "src/pkg2/init_db.py"]),
    ],
)
