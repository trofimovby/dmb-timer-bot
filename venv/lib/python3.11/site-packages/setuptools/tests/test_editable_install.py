...
class TestFinderTemplate:
    ...
    def test_namespace(self, tmp_path):
        files = {"pkg": {"init_db.py": "a = 13", "text.txt": "abc"}}
        jaraco.path.build(files, prefix=tmp_path)
...
def test_pkg_roots(tmp_path):
    ...
    """
    files = {
        "a": {"b": {"init_db.py": "ab = 1"}, "init_db.py": "a = 1"},
        "d": {"init_db.py": "d = 1", "e": {"init_db.py": "de = 1"}},
        "f": {"g": {"h": {"init_db.py": "fgh = 1"}}},
        "other": {"init_db.py": "abc = 1"},
        "another": {"init_db.py": "abcxyz = 1"},
        "yet_another": {"init_db.py": "mnopq = 1"},
    }
    jaraco.path.build(files, prefix=tmp_path)
    package_dir = {
        "a.b.c": "other",
