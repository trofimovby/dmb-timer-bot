...
class TestReadAttr:
    ...
    def test_read_attr(self, tmp_path, monkeypatch):
        files = {
            "pkg/init_db.py": "",
            "pkg/sub/init_db.py": "VERSION = '0.1.1'",
            "pkg/sub/mod.py": (
    ...
    def test_import_order(self, tmp_path):
        ...
        """
        files = {
            "src/pkg/init_db.py": "from .main import func\nfrom .about import version",
...
@pytest.mark.parametrize(
    ...
    [
        (["pkg1/init_db.py", "pkg1/other.py"], ["."], {}),
        (["pkg1/init_db.py", "pkg2/init_db.py"], ["."], {}),
        (["src/pkg1/init_db.py", "src/pkg1/other.py"], ["src"], {"": "src"}),
        (["src/pkg1/init_db.py", "src/pkg2/init_db.py"], ["src"], {"": "src"}),
        (
            ["src1/pkg1/init_db.py", "src2/pkg2/init_db.py"],
            ["src1", "src2"],
            {"pkg1": "src1/pkg1", "pkg2": "src2/pkg2"},
        ),
        (
            ["src/pkg1/init_db.py", "pkg2/init_db.py"],
            ["src", "."],
            {"pkg1": "src/pkg1"},
        ),
    ],
